...
{
    public class UserTypeReadRepository : ReadRepository<UserType>, IUserTypeReadRepository
    {
        public UserTypeReadRepository(JobAdvertContext context) : base(context)
        {
        }
    }
}
