...
{
    public class UserCvFileReadRepository : ReadRepository<UserCvFile>, IUserCvFileReadRepository
    {
        public UserCvFileReadRepository(JobAdvertContext context) : base(context)
        {
        }
    }
}
